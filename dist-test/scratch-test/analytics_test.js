...
const weekly = (0, hairAnalytics_1.calculateWeeklyAnalytics)(mockLogs, [mockCoreRoutine]);
...
const monthly = (0, hairAnalytics_1.calculateMonthlyAnalytics)(mockLogs);
...
const productUsage = (0, hairAnalytics_1.calculateProductAnalytics)([mockProduct1, mockProduct2], mockLogs);
...
const trend = (0, hairAnalytics_1.calculateConditionTrends)(mockConditions);
...
const analyticsVM = (0, hairAnalytics_1.buildHairAnalyticsVM)([mockProduct1, mockProduct2], [mockHairRoutine], [mockCoreRoutine], mockLogs, mockPhotos, mockConditions);
