...
exports.FallbackHeuristicSleepAIProvider = void 0;
class FallbackHeuristicSleepAIProvider {
    name = 'heuristic';
    async askCoach(question, context) {
        ...
        if (q.includes('consistent') || q.includes('schedule') || q.includes('weekend')) {
            ...
            return `Your schedule consistency is currently at ${context.consistencyScore}%. ${socialJetlag
    ...
    async generateWeeklyReview(context) {
        ...
        summary = `This week, your sleep duration averaged ${(context.weeklyAverages.averageDurationMinutes / 60).toFixed(1)} hours with a recovery rating of ${context.weeklyAverages.averageRecoveryScore.toFixed(0)}%. ${areasToImprove.length > 0
...
exports.FallbackHeuristicSleepAIProvider = FallbackHeuristicSleepAIProvider;
