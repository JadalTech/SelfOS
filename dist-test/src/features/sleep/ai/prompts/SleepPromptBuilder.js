...
exports.SleepPromptBuilder = void 0;
class SleepPromptBuilder {
    /**
...
- Keep all recommendations non-clinical, behavioral, and safe.`;
     ...
     */
    static buildContextSection(context) {
...
JSON Schema:
{
  ...
  "healthScore": number (calculated sleep score rating between 1 and 10 based on consistency and quality)
     ...
     */
    static buildGoalReviewPrompt(goals, context) {
...
exports.SleepPromptBuilder = SleepPromptBuilder;
