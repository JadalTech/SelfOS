...
exports.NutritionContextBuilder = void 0;
class NutritionContextBuilder {
    static buildAIContext(dailyLog, activeGoal, streak = 0, weeklyAvgCalories = 2000, weeklyAdherence = 8, favorites = []) {
...
exports.NutritionContextBuilder = NutritionContextBuilder;
