...
exports.calculateNutritionFactsForEntry = calculateNutritionFactsForEntry;
exports.calculateMealTotals = calculateMealTotals;
exports.calculateDailyNutritionTotals = calculateDailyNutritionTotals;
exports.calculateBMR = calculateBMR;
exports.calculateTDEE = calculateTDEE;
exports.calculateBMI = calculateBMI;
exports.calculateRecommendedProtein = calculateRecommendedProtein;
exports.calculateMacroDistribution = calculateMacroDistribution;
exports.calculateRemainingMacros = calculateRemainingMacros;
exports.calculateNutritionQualityScore = calculateNutritionQualityScore;
function calculateNutritionFactsForEntry(quantity, servingSize, baseFacts) {
 ...
 */
function calculateBMR(weightKg, heightCm, age, biologicalSex) {
...
function calculateRecommendedProtein(weightKg, target) {
    if (weightKg <= 0)
        return 0;
    const multipliers = {
        maintenance: 1.2,
...
function calculateMacroDistribution(facts) {
...
function calculateRemainingMacros(dailyLog, goal) {
    return {
 ...
 */
function calculateNutritionQualityScore(dailyLog, goal) {
    ...
    const weighted = calorieAdherence * 0.35 +
        proteinScore * 0.35 +
        carbRatio * 0.15 +
        fatRatio * 0.15;
