...
exports.isRoutineScheduledForDate = isRoutineScheduledForDate;
exports.isScheduledTodayInTimezone = isScheduledTodayInTimezone;
/**
 ...
 */
function getLocalDateInTimezone(timezone, date = new Date()) {
    try {
 ...
 */
function isRoutineScheduledForDate(routine, targetDate) {
 ...
 */
function isScheduledTodayInTimezone(routine, referenceDate = new Date()) {
