...
class RuleRecommendationEngine {
    static detectRecommendations(context) {
        ...
        const expiredProducts = context.activeProducts.filter((p) => {
            const exp = (0, skincareEngine_1.calculateProductExpiry)(p.openedDate, p.shelfLifeMonths);
...
exports.RuleRecommendationEngine = RuleRecommendationEngine;
