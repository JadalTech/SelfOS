...
exports.skinReminderConverter = exports.progressPhotoConverter = exports.skinAssessmentConverter = exports.skincareLogConverter = exports.skincareRoutineConverter = exports.skincareProductConverter = void 0;
const firestore_1 = require("firebase/firestore");
exports.skincareProductConverter = {
    toFirestore(product) {
        return {
            ...
            openedDate: product.openedDate instanceof Date ? firestore_1.Timestamp.fromDate(product.openedDate) : null,
            shelfLifeMonths: product.shelfLifeMonths ?? null,
            expiryDate: product.expiryDate instanceof Date ? firestore_1.Timestamp.fromDate(product.expiryDate) : null,
    ...
    fromFirestore(snapshot, options) {
        ...
        return {
            ...
            openedDate: data.openedDate instanceof firestore_1.Timestamp ? data.openedDate.toDate() : undefined,
            shelfLifeMonths: typeof data.shelfLifeMonths === 'number' ? data.shelfLifeMonths : undefined,
            expiryDate: data.expiryDate instanceof firestore_1.Timestamp ? data.expiryDate.toDate() : undefined,
...
exports.skincareRoutineConverter = {
    toFirestore(routine) {
        return {
...
exports.skinAssessmentConverter = {
    toFirestore(assessment) {
        return {
            ...
            createdAt: assessment.createdAt instanceof Date ? firestore_1.Timestamp.fromDate(assessment.createdAt) : firestore_1.Timestamp.now(),
            updatedAt: firestore_1.Timestamp.now(),
        };
    },
    fromFirestore(snapshot, options) {
...
exports.progressPhotoConverter = {
    toFirestore(photo) {
        return {
            userId: photo.userId,
...
exports.skinReminderConverter = {
    toFirestore(reminder) {
        return {
            ...
            createdAt: reminder.createdAt instanceof Date ? firestore_1.Timestamp.fromDate(reminder.createdAt) : firestore_1.Timestamp.now(),
            updatedAt: firestore_1.Timestamp.now(),
        };
    },
    fromFirestore(snapshot, options) {
