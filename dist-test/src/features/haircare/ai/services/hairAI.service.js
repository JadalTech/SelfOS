...
exports.hairAIService = exports.HairAIService = exports.FallbackHeuristicAIProvider = void 0;
const promptBuilder_1 = require("../prompts/promptBuilder");
class FallbackHeuristicAIProvider {
...
exports.FallbackHeuristicAIProvider = FallbackHeuristicAIProvider;
class HairAIService {
    provider;
    constructor(provider = new FallbackHeuristicAIProvider()) {
    ...
    async askCoach(ctx, userMessage, history = []) {
    ...
    async generateWeeklyReview(ctx) {
...
exports.HairAIService = HairAIService;
exports.hairAIService = new HairAIService();
