...
import { mapToHairPhotoVM, groupPhotosByMonth } from '../src/features/haircare/mappers/photos.mapper';
import { hairPhotoUploadSchema } from '../src/features/haircare/validation/haircare.validation';
import type { HairPhoto } from '../src/features/haircare/types/photo.types';
...
const validUpload = hairPhotoUploadSchema.parse({
...
const vm1 = mapToHairPhotoVM(mockPhoto1);
...
const photoVMs = [mapToHairPhotoVM(mockPhoto1), mapToHairPhotoVM(mockPhoto2), mapToHairPhotoVM(mockPhoto3)];
const groups = groupPhotosByMonth(photoVMs);
