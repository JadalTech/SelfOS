...
} from '../src/features/dashboard/utils/dashboardMapper';
import type { Routine, RoutineLog } from '../src/features/routine/types';
import type { AppUser } from '../src/shared/stores';
...
const greeting = mapGreeting(mockUser, referenceDate);
...
const progress = mapTodayProgress(mockRoutines, mockLogs, referenceDate);
...
const todayList = mapTodayRoutines(mockRoutines, mockLogs, referenceDate);
...
const stats = mapStats(mockRoutines, mockLogs);
...
const vm = buildDashboardViewModel(mockUser, mockRoutines, mockLogs, referenceDate);
