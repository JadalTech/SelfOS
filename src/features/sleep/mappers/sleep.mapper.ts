import type { SleepEntry, SleepSchedule, SleepGoal, SleepRecovery } from '../types/sleep.types';
import type { SleepEntryVM, SleepScheduleVM, SleepGoalVM, SleepRecoveryVM, SleepDashboardVM } from '../types/viewmodel.types';
 ...
 */
export function formatDateToTimeString(date: Date | any): string {
  if (!date) return '';
 ...
 */
export function mapToSleepEntryVM(entry: SleepEntry): SleepEntryVM {
 ...
 */
export function mapToSleepScheduleVM(schedule: SleepSchedule): SleepScheduleVM {
  return {
    id: schedule.id,
 ...
 */
export function mapToSleepGoalVM(goal: SleepGoal, progressPercent: number = 0): SleepGoalVM {
 ...
 */
export function mapToSleepRecoveryVM(recovery: SleepRecovery): SleepRecoveryVM {
 ...
 */
export function buildSleepDashboardVM(
  latestEntry: SleepEntry | null,
  activeSchedule: SleepSchedule | null,
  recovery: SleepRecovery | null,
  streakCount: number,
